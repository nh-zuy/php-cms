					...
					<div class="row">
						...
						<div class="col-md-12 col-xs-12">
							<div class="x_panel">
								...
								<div class="x_title">
									<h2>Thêm<small>sản phẩm</small></h2>
								...
								<div class="x_content">
									...
									<form class="form-horizontal form-label-left" method="post">
										...
										<div class="form-group">
											...
											<div class="col-md-10 col-sm-10 col-xs-12">
												<input type="text" name="productName" class="form-control" placeholder="Tên sản phẩm ... " required="required" value="">
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-md-10 col-sm-10 col-xs-12">
												<textarea placeholder="Mô tả sản phẩm ..." required="required" name="productDes" class="resizable_textarea form-control" style="width: 100%; overflow: hidden; word-wrap: break-word; resize: horizontal; height: 87px;"></textarea>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-md-10 col-sm-10 col-xs-12">
												<input required type="text" class="tags form-control" name="productUnit" value="" placeholder="Giá thành sản phẩm ..." />
										...
										<div class="form-group">
											...
											<div class="col-md-10 col-sm-10 col-xs-12">
												<div class="">
													<input type="checkbox" class="js-switch" checked name="productStatus"/> 
