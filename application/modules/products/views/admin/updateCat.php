					...
					<div class="row">
						...
						<div class="col-md-12 col-xs-12">
							<div class="x_panel">
								...
								<div class="x_title">
									<h2>Chỉnh sửa danh mục<small>sản phẩm</small></h2>
									...
									<form class="form-horizontal form-label-left" method="post">
										...
										<div class="form-group">
											...
											<div class="col-md-10 col-sm-10 col-xs-12">
												<input type="text" name="productCatName" class="form-control" required="required" value="<?= $productCat['cat_name']; ?>">
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-md-10 col-sm-10 col-xs-12">
												<textarea required="required" name="productCatDes" class="resizable_textarea form-control" style="width: 100%; overflow: hidden; word-wrap: break-word; resize: horizontal; height: 87px;"><?= $productCat['cat_des']; ?></textarea>
											</div>
										</div>
										...
										<div class="form-group">
											<label class="control-label col-md-2 col-sm-2 col-xs-12">Thông tin chi tiết </span>
											</label>
											...
											<div class="col-md-10 col-sm-10 col-xs-12">
												...
												<div id="editor"><?= $productCat['cat_content']; ?></div>
												<textarea name="productCatContent" id="descr" style="display:none;"></textarea>
												<br />
										...
										<div class="form-group">
											<label for="productCatStatus" class="control-label col-md-2 col-sm-2 col-xs-12">Hiển thị</label>

											<div class="col-md-10 col-sm-10 col-xs-12">
												<div class="">
													<input type="checkbox" class="js-switch" <?= ($productCat['cat_status']) ? 'checked' : ''; ?> name="productCatStatus"/>
												</div>
											</div>
										</div>
